...
4. [📋 설계 패턴](#-설계-패턴)  
   - [싱글턴 패턴](#싱글턴-패턴)  
   - [프로토콜 기반 DI](#프로토콜-기반-di)  
5. [🛠️ 기술 스택](#️-기술-스택)  
6. [🚀 트러블 슈팅](#-트러블-슈팅)  
   - [효율적인 네트워크 활용을 위한 API 호출 제어 전략](#효율적인-네트워크-활용을-위한-api-호출-제어-전략)  
   - [다운샘플링과 임시 파일 활용으로 메모리 사용량 개선](#다운샘플링과-임시-파일-활용으로-메모리-사용량-개선)  
   - [Realm 객체 삭제 오류 해결](#realm-객체-삭제-오류-해결)  
7. [🗂️ 파일 디렉토리 구조](#️-파일-디렉토리-구조)  
8. [🛣️ 향후 계획](#️-향후-계획)  
...
## Realm 객체 삭제 오류 해결: DTO 패턴을 활용한 안정적 데이터 처리
